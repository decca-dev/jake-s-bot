...
module.exports = async (message) => {
    ...
    if (message.content.toLowerCase().includes('quirky')) message.channel.send(':hot_face: aha fuck');
    ...
    if (message.content.toLowerCase().includes('jake') || message.content.toLowerCase().includes('jakey')) message.channel.send(':heart: Ily jake')
